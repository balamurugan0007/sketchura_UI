...
class SkColors {
  ...
  static const Color primaryLight = Color.fromARGB(255, 159, 180, 223);
  static const Color primaryDark = Color.fromARGB(255, 57, 88, 172);
  static const Color primaryMedium = Color.fromARGB(255, 102, 139, 204);
  static const Color primaryLightest = Color.fromARGB(255, 224, 233, 245);
  ...
  static const Color lightlight = Color(0XFFF8F9FE);
  ...
  static const Color infoMedium = Color(0xFF81B5F8);
  static const Color infoLight = Color(0xFFECF1F9);
}
